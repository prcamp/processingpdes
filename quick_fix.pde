...
void randsporeclrs() {
  spore1 = color(random(255),random(255),255);
  spore2 = color(random(255),random(255),255);
  spore3 = color(random(255),random(255),255);
  spore4 = color(random(255),random(255),255);
}
